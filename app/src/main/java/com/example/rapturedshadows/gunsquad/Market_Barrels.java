...
public class Market_Barrels extends AppCompatActivity {
    private List<Barrels_Attachments> scopes = new ArrayList<>();
    Button back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_market__barrels);
    ...
    public void populateUnits() {
        scopes.add(new FlashHider());
        scopes.add(new MuzzleBrake());
        scopes.add(new Silencer());
    }

    private void populateList() {
        ArrayAdapter<Barrels_Attachments> adapter = new Market_Barrels.MyListAdapter();
        ListView list = (ListView)findViewById(R.id.scope_list);
        list.setAdapter(adapter);
    }

    public class MyListAdapter extends ArrayAdapter<Barrels_Attachments> {
        public MyListAdapter() {
            super(Market_Barrels.this, R.layout.weapon_view_market, scopes);
        }
        ...
        public View getView(int position, final View convertView, ViewGroup parent){
            ...
            //find soldier
            final Barrels_Attachments currentUnit = scopes.get(position);
